...
if (numUsuario % 2 === 0) {
    console.log("O Número " + numUsuario + " é divisível por 2.")
}else if (numUsuario % 3 === 0){
    console.log("O Número " + numUsuario + " é divisível por 3.")
}else {
    console.log("O número " + numUsuario + " não é divisível por 2 ou 3.")
}

//2. Utilizando um operador lógico para unir duas operações relacionais

if(numUsuario % 2 === 0 || numUsuario % 3 === 0){
    console.log("O Número " + numUsuario + " é divisível por 2 ou 3.")
}else{
    console.log("O número " + numUsuario + " não é divisível por 2 ou 3.")
}